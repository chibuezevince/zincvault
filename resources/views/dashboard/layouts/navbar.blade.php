         ...
         <nav id="mainNavbar" class="navbar navbar-vertical navbar-expand-lg scrollbar bg-dark navbar-dark">
            ...
            <div class="container-fluid">
                ...
                <a class="navbar-brand" href="/dashboard">
                    ...
                    <img src="{{asset('assets/logo/logo-dark.png')}}" class="navbar-brand-img logo-dark logo-large" alt="..." width="125" height="25">
                </a>       
              <!-- Navbar toggler -->
                    ...
                    <ul class="navbar-nav mb-lg-7">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link " href="#authenticationEmailVerificationCollapse" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="authenticationEmailVerificationCollapse">
                                <span class="material-icons pb-1">supervised_user_circle</span>&nbsp;&nbsp; Transfer
                            </a>
                            <div class="collapse " id="authenticationEmailVerificationCollapse">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a href="{{route("dashboard.local_transfer")}}" class="nav-link ">
                                            Local Transfer
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('dashboard.international_transfer')}}" class="nav-link ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="{{{route('dashboard.exchange')}}}">
                                <span class="material-icons pb-1">compare_arrows</span>&nbsp;&nbsp;
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="/logout">
                                <span class="material-icons pb-1 text-danger">logout</span>&nbsp;&nbsp;
                            ...
                            <div class="dropdown">
                                <a href="javascript: void(0);" class="dropdown-toggle no-arrow d-flex align-items-center justify-content-center bg-white rounded-circle shadow-sm mx-1 mx-lg-2 w-40px h-40px" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false" data-bs-offset="0,10">
                                    <div class="avatar avatar-circle avatar-sm avatar-online">
                                        <img src="{{user_details()->profile_image}}" alt="..." class="avatar-img" width="40" height="40">
                                    </div>
                                </a>
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <span class="dropdown-item">Dollar Balance : ${{number_format(user_details()->dollar_balance, 2)}}</span>
                                    <hr class="dropdown-divider">
                                    <span class="dropdown-item">Euro Balance : €{{number_format(user_details()->euro_balance, 2)}}</span>
                                    <hr class="dropdown-divider">
                                    <span class="dropdown-item">Pound Balance : £{{number_format(user_details()->pound_balance, 2)}}</span>
                                    <hr class="dropdown-divider">
                    
                                    <a class="dropdown-item" href="{{route('dashboard.profile')}}">Profile & Account Settings</a>
