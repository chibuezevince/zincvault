...
<div class="container-fluid">
    ...
    <div class="row">
                    ...
                    <div class="text-center mb-5">
                        <div class="avatar avatar-xxl avatar-circle mb-5">
                            <label class="d-block cursor-pointer">
                                ...
                                <form action="{{route('admin.avatar')}}" method="POST" id="adminAvatarUpload" enctype="multipart/form-data">
                                @csrf
                                    <input type="file" name="avatar" id="avatar" class="d-none">
                            </label>
                            <img src="{{$user_details->profile_image}}" alt="" class="avatar-img">
                        ...
                        <span class="small text-secondary fw-semibold">{{$user_details->account_type}}</span><br>
                        <span class="small text-secondary fw-semibold">Account Number:  {{$user_details->account_number}}</span><br>
                        <hr>

                        <b>Account Balance</b> <br>
                        <span> Dollar Balance: ${{number_format($user_details->dollar_balance)}}</span><br>
                        <span>Euro Balance: ${{number_format($user_details->euro_balance)}}</span><br>
                        <span>Pound Balance: ${{number_format($user_details->pound_balance)}}</span>
                    </div>
        ...
        <div class="col">
            <form id="adminBasicInfoForm" action="{{route('admin.basic_info')}}" method="POST">
                @csrf
                <!-- Card -->
            ...
            <form action="{{route('admin.password')}}" method="POST" id="adminPasswordForm">
                @csrf
                <!-- Card -->
            ...
            <form action=" {{route('admin.cred_deb')}} " method="POST" id="credDebForm">
                ...
                <div class="card border-0 scroll-mt-3" id="creditDebitSection">
                    ...
                    <div id="credDebError" class="alert alert-danger" style="display: none"></div>
                    <div id="credDebSuccess" class="alert alert-success" style="display: none"></div>
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-lg">
                        ...
                        <div class="d-flex justify-content-end mt-5">
                            ...
                            <!-- Button -->
                            <button id="creddeb_loading" class="btn btn-primary" type="button" disabled style="display: none">
                                <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                                <span class="sr-only">Loading...</span>
                            </button>
                            <button id="creddeb_done" type="submit" class="btn btn-primary">Update</button>    
                        </div> 
                    </div>
                </div>
                </form>
                    ...
                    <form method="POST" action="{{route('admin.activate_deactivate')}}">
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                ...
                                <!-- Input -->
                                <input type="checkbox" required class="form-check-input" id="deactivateAccount" name="deactivateAccount" value="1">

                                <!-- Label -->
                                <label class="form-check-label" for="deactivateAccount">
                    ...
                    <form method="POST" action=" {{route('admin.activate_deactivate')}} ">
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                ...
                                <!-- Input -->
                                <input required type="checkbox" class="form-check-input" id="activateAccount" name="activateAccount" value="1">

                                <!-- Label -->
                                <label class="form-check-label" for="activateAccount">
...
<script>
    iziToast.success
    ({
        message: '{{session('account_success')}}',
        position: 'topRight',
    });
</script>
@endif
