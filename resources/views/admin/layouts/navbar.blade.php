              ...
              <!-- Navbar toggler -->
                ...
                <div class="collapse navbar-collapse" id="sidenavCollapse">
                    ...
                    <ul class="navbar-nav mb-lg-7">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="collapse " id="authenticationEmailVerificationCollapse">
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('admin.user_signup')}}" class="nav-link ">
                                            Create New User
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="{{{route('admin.local_transfer')}}}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="{{{route('admin.all_requests')}}}">
                                <span class="material-icons pb-1">trending_up</span>&nbsp;&nbsp;
                                <span>All Transfer Request</span>
                            </a>
                        </li>


                        <li class="nav-item">
                            <a class="nav-link " href="{{{route('admin.all_transactions')}}}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="{{{route('admin.site_settings')}}}">
                                <span class="material-icons pb-1">settings</span>&nbsp;&nbsp;
                        ...
                        <div class="d-flex align-items-center ms-auto me-n1 me-lg-n2">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="/dashboard/profile/">Profile & Account Settings</a>
